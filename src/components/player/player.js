// https://raw.githubusercontent.com/CezarLuiz0/react-cl-audio-player/master/src/ClAudioPlayer.js
...
var CLAudioPlayer = React.createClass({
  ...
  componentWillReceiveProps(newProps) {
    this.audio.src = newProps.songs[0].url;
    this.audio.play();
    
    this.setState({
      active: newProps.songs[0],
